                ...
                <div class="medium-6 small-12 columns item-detail">
                    ...
                    <div class="item-options" dir="rtl">
                        ...
                        <span class="row-title">{{Lang::get('tr.'. $vari['Name'])}}
                            :</span>
                                        <span>
                            <select class="cn"  id="vali{{$a++}}" name="variation" data-variation="{{ $vari['Name'] }}" onchange="myFunction()">
                        ...
                        <span class="row-title">{{Lang::get('tr.'. $it['Variations']['VariationSpecificsSet']['NameValueList']['Name'])}}
                            ...
                            <select class="cn" id="vali{{$a++}}" name="variation"
                                    data-variation="{{ $it['Variations']['VariationSpecificsSet']['NameValueList']['Name'] }}" onchange="myFunction()">
                                <option value="^^^SELECT^^^">בחר</option>
                            </select>
                                                                <span class="select-error" id="er{{$b++}}" style="display: none">נא לבחור</span>
                    ...
                    <div class="item-quantity" dir="rtl">
                        <div class="option-box"><span class="row-title" style="width: 66px">כמות:</span><span id="avamsg" class="row-title" style="width:100px;text-align:left;">&nbsp;</span><span><input type="number" class="qty" value="1"/> יחידות</span>
