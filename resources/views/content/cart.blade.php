                ...
                <div class="small-module">
                        ...
                        <div class="medium-8 small-12 columns responsive-table" style="padding-left: 0.4rem; padding-right: 0.4rem">
                            ...
                            <table class="shop_table cart responsive">
                                ...
                                <tr class="cart-item" data-id="{{$item['id']}}">
                                    ...
                                    <input type="hidden" id="itemAttributes"
                                           value="{{$item['attributes']['attribute']}}"/>
                                    <input type="hidden" id="currentPrice"
                                           value="{{$item['attributes']['realprice']}}"/>
                                </tr>
                                @endforeach
                                </tbody>
                        ...
                        <div class="medium-4 small-12 columns infoAddress" dir="rtl">
                         ...
                         <form  method="post" action="" dir="rtl">
                            ...
                            <input type="submit" id="btnpay" name="btnpay" class="button primary float-right"
                                   value="לתשלום" style="margin-top: 5px;"/>
                            </div>
