                                ...
                                @foreach($it['Variations']['VariationSpecificsSet']['NameValueList'] as $key=>$vari)
                                    <div class="option-box">
                                        <span class="row-title">{{str_replace($variname['ENGLISH'], $variname['Hebrew'], $vari['Name']) }}
                                            :</span>
                                        <span>
                                                  <select hidden id="hdvali{{$a}}" name="variation"
                                        ...
                                        @if(is_array($vari['Value']))
                                                          ...
                                                          @foreach($vari['Value'] as $valn)
                                                              ...
                                                              <option class="rem"
                                                                      value="{{ $valn }}">{{ $valn }}</option>
                                                          @endforeach
                                                      @else
                                                          <option>בחר</option>
                                                          <option class="rem"
                                                                  value="{{ $valn }}">{{ $vari['Value'] }}</option>
                                                      @endif
                                        </select>
                                        ...
                                        @if(is_array($vari['Value']))
                                                ...
                                                @foreach($vari['Value'] as $valn)
                                                    ...
                                                    <option class="rem" value="{{ $valn }}">{{ $valn }}</option>
                                                @endforeach
                                            @else
                                                <option>בחר</option>
                                                <option class="rem" value="{{ $valn }}">{{ $vari['Value'] }}</option>
                                            @endif
                                        </select>
...
$('select').data('variation', '{{ $it['Variations']['Pictures']['VariationSpecificName'] }}').on('change', function () {
        ...
        if (vars == 2) {
            ...
            $('.cn').on('change', function () {
                ...
                $.each(arry, function (key, value) {
                    ...
                    $('#hd' + xx).find('option').each(function (kk, vv) {

                        op = $(this).text();


                        if (value.includes("val" + op + "val") && value.includes("val" + sel + "val")) {
        ...
        if (vars == 3) {
            for (a = 1; a < 3; a++) {
                ...
                $('#vali' + a).find('option').each(function () {
                    x = $(this).val();
                    hidded = true;
                    ...
                    $.each(info['Variation'], function (kay, value) {
                        ...
                        if (saar > 0) {
                            ...
                            vari = value['VariationSpecifics']['NameValueList'][b]['Value'];
            ...
            $('.cn').on('change', function () {
                    sel = $(this).val();
                    varid = $(this).attr('id');
                    vars = ['vali1', 'vali2', 'vali3'];

                    number = 0;

                    $('.cn').attr('data-' + varid, sel);

                    vali1 = $(this).data('vali1');
                    vali2 = $(this).data('vali2');
                    vali3 = $(this).data('vali3');

                    if (vali1 && vali2 || vali1 && vali3 || vali2 && vali3) {
                        number = 2;
                    }
                    ...
                    if (varid == 'vali1') {
                        varget = $('#vali2 option').eq(1).val();

                    } else {
                        varget = $('#vali1 option').eq(1).val();
                    ...
                    if (number == 0) {
                        ...
                        selected = ($("#" + varid).prop('selectedIndex'));
                        ...
                        if (selected != 0) {
                            ...
                            select = "<option>בחר</option>";
                            $.each(arry, function (key, value) {


                                $('#hd' + varid).find('option').each(function (kk, vv) {

                                    op = $(this).text();

                                    if (value.includes("val" + op + "val") && value.includes("val" + sel + "val") && value.includes("val" + varget + "val")) {
                        ...
                        selected = ($("#" + op3).prop('selectedIndex'));
                        ...
                        $.each(arry, function (key, value) {
                            ...
                            $('#hd' + op3).find('option').each(function (kk, vv) {

                                op = $(this).text();

                                if (value.includes("val" + op + "val") && value.includes("val" + op1 + "val") && value.includes("val" + op2 + "val")) {
                        ...
                        $('.cn').on('click', function () {
                            $('.cn').on('focusin', function () {
                                $('#vali2,#vali3,#vali1').removeClass('cn');
                                id = $(this).attr('id');


                                if (id == 'vali1') {

                                    $('#vali2,#vali3,#vali1').removeClass();
                                    $('#vali2,#vali3,#vali1').addClass('cn');
                                    $('#' + id).toggleClass('calsi cn');
                                ...
                                if (id != varid) {
                                    ...
                                    $.each(arry, function (key, value) {
                                        ...
                                        $('#hd' + id).find('option').each(function (kk, vv) {
                                            console.log(id);
                        ...
                        $('.cn').on('click', function () {
                            ...
                            if (id != varid) {
                                ...
                                selected = ($("#" + id).prop('selectedIndex'));
